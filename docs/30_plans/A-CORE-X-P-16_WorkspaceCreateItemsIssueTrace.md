...
- docs/30_plans/A-CORE-X-P-16_WorkspaceCreateItemsIssueTrace.md
...
- npm run governance:audit -- --issue docs/30_plans/A-CORE-X-P-16_WorkspaceCreateItemsIssueTrace.md
- npm run check:ts
- npm run test
- npm run check:rust
