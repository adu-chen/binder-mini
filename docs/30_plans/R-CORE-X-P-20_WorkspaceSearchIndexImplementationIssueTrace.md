...
- docs/30_plans/R-CORE-X-P-20_WorkspaceSearchIndexImplementationIssueTrace.md
...
- npm run governance:audit -- --issue docs/30_plans/R-CORE-X-P-20_WorkspaceSearchIndexImplementationIssueTrace.md
- npm run check:ts
- npm run test
- npm run check:rust
