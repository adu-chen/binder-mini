...
- docs/30_plans/R-CORE-X-P-25_EditorMarkdownRuntimeIssueTrace.md
...
- npm run governance:audit -- --issue docs/30_plans/R-CORE-X-P-25_EditorMarkdownRuntimeIssueTrace.md
- npm run check:ts
- npm run test
