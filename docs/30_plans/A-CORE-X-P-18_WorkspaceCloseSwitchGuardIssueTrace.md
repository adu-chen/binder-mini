...
- docs/30_plans/A-CORE-X-P-18_WorkspaceCloseSwitchGuardIssueTrace.md
...
- npm run governance:audit -- --issue docs/30_plans/A-CORE-X-P-18_WorkspaceCloseSwitchGuardIssueTrace.md
- npm run check:ts
- npm run test
