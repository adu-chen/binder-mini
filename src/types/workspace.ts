 ...
 * rules: BR-WS-STATE-001, BR-WS-STATE-002, BR-WS-DATA-001, BR-WS-DATA-002
 * boundary: in=Workspace selection and file operation target | out=Workspace boundary, metadata, and recursive FileNode structure
